...
parser.add_argument("--input","-i",type=str,required=True,help="Input file path(Required)")
parser.add_argument("--output","-o",type=str,default="./output.hack",required=False,help="Output file path(Optional)\nDefault path = ./output.hack")
